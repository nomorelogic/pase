...
(
  ...
  CONSTRAINT INTEG_2 PRIMARY KEY (COUNTRY)
);
...
(
  ...
  CONSTRAINT INTEG_16 PRIMARY KEY (DEPT_NO),
  CONSTRAINT INTEG_15 UNIQUE (DEPARTMENT)
);
...
(
  ...
  CONSTRAINT INTEG_27 PRIMARY KEY (EMP_NO)
);
CREATE TABLE EMPLOYEE_PROJECT
(
  EMP_NO EMPNO NOT NULL,
  PROJ_ID PROJNO NOT NULL,
  CONSTRAINT INTEG_39 PRIMARY KEY (EMP_NO,PROJ_ID)
);
CREATE TABLE JOB
(
  JOB_CODE JOBCODE NOT NULL,
...
(
  ...
  TEAM_LEADER EMPNO,
  PRODUCT PRODTYPE,
  CONSTRAINT INTEG_35 PRIMARY KEY (PROJ_ID),
  CONSTRAINT INTEG_34 UNIQUE (PROJ_NAME)
);
...
(
  ...
  CONSTRAINT INTEG_46 PRIMARY KEY (FISCAL_YEAR,PROJ_ID,DEPT_NO)
);
...
(
  ...
  ITEM_TYPE PRODTYPE,
  CONSTRAINT INTEG_76 PRIMARY KEY (PO_NUMBER)
);
/********************* VIEWS **********************/
...
ALTER TABLE CUSTOMER ADD CONSTRAINT INTEG_61
  FOREIGN KEY (COUNTRY) REFERENCES COUNTRY (COUNTRY);
ALTER TABLE CUSTOMER ADD CONSTRAINT INTEG_59
...
ALTER TABLE DEPARTMENT ADD CONSTRAINT INTEG_17
  FOREIGN KEY (HEAD_DEPT) REFERENCES DEPARTMENT (DEPT_NO);
ALTER TABLE DEPARTMENT ADD CONSTRAINT INTEG_31
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT INTEG_29
  FOREIGN KEY (JOB_CODE,JOB_GRADE,JOB_COUNTRY) REFERENCES JOB (JOB_CODE,JOB_GRADE,JOB_COUNTRY);
ALTER TABLE EMPLOYEE ADD CONSTRAINT INTEG_30
...
ALTER TABLE EMPLOYEE_PROJECT ADD CONSTRAINT INTEG_40
  FOREIGN KEY (EMP_NO) REFERENCES EMPLOYEE (EMP_NO);
ALTER TABLE EMPLOYEE_PROJECT ADD CONSTRAINT INTEG_41
  FOREIGN KEY (PROJ_ID) REFERENCES PROJECT (PROJ_ID);
ALTER TABLE JOB ADD CONSTRAINT INTEG_11
  FOREIGN KEY (JOB_COUNTRY) REFERENCES COUNTRY (COUNTRY);
ALTER TABLE JOB ADD CONSTRAINT INTEG_12
  CHECK (min_salary < max_salary);
CREATE DESCENDING INDEX MAXSALX ON JOB (JOB_COUNTRY,MAX_SALARY);
CREATE INDEX MINSALX ON JOB (JOB_COUNTRY,MIN_SALARY);
ALTER TABLE PROJECT ADD CONSTRAINT INTEG_36
  FOREIGN KEY (TEAM_LEADER) REFERENCES EMPLOYEE (EMP_NO);
CREATE UNIQUE INDEX PRODTYPEX ON PROJECT (PRODUCT,PROJ_NAME);
ALTER TABLE PROJ_DEPT_BUDGET ADD CONSTRAINT INTEG_47
  FOREIGN KEY (DEPT_NO) REFERENCES DEPARTMENT (DEPT_NO);
ALTER TABLE PROJ_DEPT_BUDGET ADD CONSTRAINT INTEG_48
  FOREIGN KEY (PROJ_ID) REFERENCES PROJECT (PROJ_ID);
ALTER TABLE PROJ_DEPT_BUDGET ADD CONSTRAINT INTEG_43
...
ALTER TABLE SALES ADD CONSTRAINT INTEG_77
  FOREIGN KEY (CUST_NO) REFERENCES CUSTOMER (CUST_NO);
ALTER TABLE SALES ADD CONSTRAINT INTEG_78
  FOREIGN KEY (SALES_REP) REFERENCES EMPLOYEE (EMP_NO);
ALTER TABLE SALES ADD CONSTRAINT INTEG_65
  CHECK (order_status in
                            ('new', 'open', 'shipped', 'waiting'));
ALTER TABLE SALES ADD CONSTRAINT INTEG_67
  CHECK (ship_date >= order_date OR ship_date IS NULL);
ALTER TABLE SALES ADD CONSTRAINT INTEG_68
  CHECK (date_needed > order_date OR date_needed IS NULL);
ALTER TABLE SALES ADD CONSTRAINT INTEG_69
  CHECK (paid in ('y', 'n'));
ALTER TABLE SALES ADD CONSTRAINT INTEG_71
  CHECK (qty_ordered >= 1);
ALTER TABLE SALES ADD CONSTRAINT INTEG_73
  CHECK (total_value >= 0);
ALTER TABLE SALES ADD CONSTRAINT INTEG_75
  CHECK (discount >= 0 AND discount <= 1);
ALTER TABLE SALES ADD CONSTRAINT INTEG_79
  CHECK (NOT (order_status = 'shipped' AND ship_date IS NULL));
ALTER TABLE SALES ADD CONSTRAINT INTEG_80
...
GRANT EXECUTE
 ON PROCEDURE ADD_EMP_PROJ TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADD_EMP_PROJ TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ALL_LANGS TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ALL_LANGS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE DELETE_EMPLOYEE TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE DELETE_EMPLOYEE TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE DEPT_BUDGET TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE DEPT_BUDGET TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE GET_EMP_PROJ TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE GET_EMP_PROJ TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE MAIL_LABEL TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE MAIL_LABEL TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ORG_CHART TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ORG_CHART TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SHIP_ORDER TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SHIP_ORDER TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SHOW_LANGS TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SHOW_LANGS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SUB_TOT_BUDGET TO  "PUBLIC" WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SUB_TOT_BUDGET TO  SYSDBA WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON DEPARTMENT TO  "PUBLIC" WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON DEPARTMENT TO  SYSDBA WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON EMPLOYEE_PROJECT TO  "PUBLIC" WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON EMPLOYEE_PROJECT TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON JOB TO  "PUBLIC" WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON JOB TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON PROJECT TO  "PUBLIC" WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON PROJECT TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON PROJ_DEPT_BUDGET TO  "PUBLIC" WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON PROJ_DEPT_BUDGET TO  SYSDBA WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON SALES TO  "PUBLIC" WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON SALES TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON PHONE_LIST TO  "PUBLIC" WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON PHONE_LIST TO  SYSDBA WITH GRANT OPTION;
